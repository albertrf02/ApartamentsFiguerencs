        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-8">
                    ...
                    <hr>
        <form method="POST" action="index.php?r=uploadapartament">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="preuDiaTemporadaBaixa" name="preuDiaTemporadaBaixa">
            </div>
            <div class="form-group">
                <label for="preuDiaTemporadaAlta">Preu dia temporada alta</label>
                <input type="text" class="form-control" id="preuDiaTemporadaAlta" name="preuDiaTemporadaAlta">
            </div>
            <div class="form-group">
